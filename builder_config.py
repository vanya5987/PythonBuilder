...
class BuilderConfig:
    def __init__(self):
        ...
        # Пути к бинарным файлам и директориям. (Аналогично path_config но с собственной конфигурацией).
        ...
        # Словарь бинарных файлов для скрытого импорта в сборку.
        self.binary_files: Dict[str, str] = {
            data_base_path: os.path.join("backend", "src", "db"),
        }

        # Словарь файлов для копирования в partable папку с исполняемым файлом.
